...
class Estado:
    ...
    def __init__(self, tabuleiro: Tabuleiro, jogadores: list[Jogador]):
        ...
        "qtd_dist_cada_tipo_classes": {"funcao": lambda x: intervalos_em_classes_vetor(conta_tipos_distritos(x), [(0, 0, 2), (1, 3, 4), (2, 5, 10000)]), "tamanho": 5, "largura": 3},
        "qtd_dist_cada_tipo_classes_bin": {"funcao": lambda x: intervalos_em_classes_vetor(conta_tipos_distritos(x), [(0, 0, 6), (1, 7, 10000)]), "tamanho": 5, "largura": 2},
