...
class Estado:
    ...
    def __init__(self, tabuleiro: Tabuleiro, jogadores: list[Jogador]):
        ...
        "ouro_personagem_classes": {"funcao": lambda x: intervalos_em_classes(x["jogador_visao"].ouro, [(1, 0, 2), (2, 3, 5), (3, 6, 10000)]), "tamanho": 1, "largura": 3},
        "ouro_personagem_proporcao": {"funcao": "", "tamanho": 1, "largura": None},
        ...
        "cartas_dist_mao_classes": {"funcao": lambda x: intervalos_em_classes(len(x["jogador_visao"].cartas_distrito_mao), [(1, 0, 2), (2, 3, 5), (3, 6, 10000)]), "tamanho": 1, "largura": 3},
        ...
        "carta_mais_cara_classes": {"funcao": lambda x: intervalos_em_classes(encontra_carta_mais_cara(x), [(1, 0, 2), (2, 3, 5), (3, 6, 10000)]), "tamanho": 1, "largura": 3},
        "carta_mais_cara_proporcao": {"funcao": "", "tamanho": 1, "largura": None},
        ...
        "carta_mais_barata_classe": {"funcao": lambda x: intervalos_em_classes(encontra_carta_mais_barata(x), [(1, 0, 2), (2, 3, 5), (3, 6, 10000)]), "tamanho": 1, "largura": 3},
        "carta_mais_barata_proporcao": {"funcao": "", "tamanho": 1, "largura": None},
        ...
        "qtd_dist_const_percent": {"funcao": "", "tamanho": 1, "largura": None},
        "qtd_dist_const_proporcao": {"funcao": "", "tamanho": 1, "largura": None},
        
        "qtd_dist_cada_tipo_padrao": {"funcao": lambda x: limitar_valores_vetor(conta_tipos_distritos(x), [0, 3]), "tamanho": 5, "largura": 4},
        "qtd_dist_cada_tipo_original": {"funcao": lambda x: conta_tipos_distritos(x), "tamanho": 5, "largura": INF},
        "qtd_dist_cada_tipo_vetor_bin": {"funcao": "", "tamanho": 5, "largura": None},
        "qtd_dist_cada_tipo_bin": {"funcao": "", "tamanho": 1, "largura": None},
        ...
        "dist_const_jog_mais_const_proporcao": {"funcao": "", "tamanho": 1, "largura": None},
        ...
        "jog_mais_cartas_mao_proporcao": {"funcao": "", "tamanho": 1, "largura": None},
        ...
        "ouro_oponentes_vetor": {"funcao": "", "tamanho": 4, "largura": None},
    ...
    def converter_estado(self, openaigym: bool = False) -> list[float]:
        ...
        print(f"Ouro: {6 if jogador_visao.ouro >= 6 else jogador_visao.ouro} / {self.metodos_por_variavel['ouro_personagem_original']['funcao'](estado)}")
        ...
        print(f"Cartas_mão: {5 if len(jogador_visao.cartas_distrito_mao) >= 5 else len(jogador_visao.cartas_distrito_mao)} / {self.metodos_por_variavel['cartas_dist_mao_original']['funcao'](estado)}")
        ...
        print(f"Maior custo: {maior_custo} / {self.metodos_por_variavel['carta_mais_cara_original']['funcao'](estado)}")
        print(f"Menor custo: {menor_custo} / {self.metodos_por_variavel['carta_mais_barata_original']['funcao'](estado)}")
        ...
        print(f"Qtd dists const: {7 if len(jogador_visao.distritos_construidos) > 7 else len(jogador_visao.distritos_construidos)} / {self.metodos_por_variavel['qtd_dist_const_original']['funcao'](estado)}")
        ...
        if nobre >= 3:
            ...
            controle.append(nobre)
        if religioso >= 3:
            estado_vetor.append(3)
            controle.append(3)
        else:
            estado_vetor.append(religioso)
            controle.append(religioso)
        if militar >= 3:
            estado_vetor.append(3)
            controle.append(3)
        else:
            estado_vetor.append(militar)
            controle.append(militar)
        if comercial >= 3:
            estado_vetor.append(3)
            controle.append(3)
        else:
            estado_vetor.append(comercial)
            controle.append(comercial)
        if especial >= 3:
            estado_vetor.append(3)
            controle.append(3)
        else:
            estado_vetor.append(especial)
            controle.append(especial)

        print(f"Dists cada tipo: {controle} / {self.metodos_por_variavel['qtd_dist_cada_tipo_original']['funcao'](estado)}")
        ...
        print(f"Qtd dists const: {7 if qtd_distritos > 7 else qtd_distritos} / {self.metodos_por_variavel['dist_const_jog_mais_const_original']['funcao'](estado)}")
        ...
        print(f"Qtd cartas maior: {5 if maior_custo >= 5 else maior_custo} / {self.metodos_por_variavel['jog_mais_cartas_mao_original']['funcao'](estado)}")
        ...
        print(f"Qtd ouro adversarios: {media} / {self.metodos_por_variavel['ouro_oponentes_original']['funcao'](estado)}")
        ...
        # print(estado_vetor, jogador_visao.personagem.rank)

        print(f"""
              vetor padrao: {estado_vetor}, 
                      novo: {estado_vetor_teste} {len(estado_vetor_teste)}
              """)
