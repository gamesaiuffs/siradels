...
# from scripts.experimentsConfig import REPRESENT
from scripts.represents import REPRESENT, METODOS_POR_VARIAVEL
...
class Estado:
    ...
    def calcula_tamanho_vetor_obsercacao(self):
        ...
        for variavel in self.variaveis:
            for _ in range(METODOS_POR_VARIAVEL[variavel]["tamanho"]):
                tamanhos.append(METODOS_POR_VARIAVEL[variavel]["largura"])
    ...
    def converter_estado(self, openaigym: bool = False) -> list[float]:
        ...
        for var in self.variaveis: 
            representacao = METODOS_POR_VARIAVEL[var]["funcao"](estado)
