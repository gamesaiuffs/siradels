...
class CartaDistrito:
    ...
    def __str__(self):
        return f'valor_do_distrito: {self.valor_do_distrito} tipo_do_distrito: {self.tipo_de_distrito} nome_do_distrito: {self.nome_do_distrito} quantidade {self.quantidade}'
