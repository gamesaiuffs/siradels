...
# gym.register(
#     id='Citadels',
#     entry_point='classes.openaigym_env.Citadels_md:Citadels',
#     # parâmetros __init__
#     # kwargs={'game': None}
# )
...
# Somente com a parte de escolha de personagens, a estratégia allin é a mesma que a frequency e 
# a build e gold vira um aleatório comum

# print("Início dos testes das estratégias")
# estrategias: list[Estrategia] = [AgenteTestes(), EstrategiaAndrei(),  EstrategiaDjonatan(), EstrategiaEduardo(),
...
for init in range(1, 11):
    ...
    estrategias: list[Estrategia] = [AgenteTestes(model=f"aaa_experimentos_final/{exp}/in_{init}/30.zip"), EstrategiaAndrei(),  EstrategiaDjonatan(), EstrategiaEduardo(), EstrategiaFelipe(), EstrategiaFrequency("Frequency"), EstrategiaGold("Gold"), EstrategiaJean(), EstrategiaLuisII(), EstrategiaTotalmenteAleatoria()]
